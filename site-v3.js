(()=>{
  if(!document.querySelector('script[data-dm-auth-gate]')){const s=document.createElement('script');s.src='/auth-gate.js?v=20260905-1';s.async=false;s.dataset.dmAuthGate='1';document.head.appendChild(s)}
